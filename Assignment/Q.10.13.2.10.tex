...
Total outcomes T\brak{E}$=2^{3}=8$\\
\brak{T,T,T}, \brak{T,T,H}, \brak{T,H,T}, \brak{T,H,H}, \brak{H,T,T}, \brak{H,T,H}, \brak{H,H,T} and \brak{H,H,H} are the favourable outcomes for this event.\\
$\therefore\pr{getting\, no \,heads}=\frac{1}{8}$\\
